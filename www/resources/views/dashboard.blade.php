...
@section('content')
    ...
    <div class="text-center mb-6 au d1">
        <div class="text-center mb-6 au d1">
            <div class="w-full px-6 py-3 rounded-2xl bg-slate-800/60 border border-slate-700/50 overflow-hidden">
                ...
                <h2 class="font-display font-700 text-white text-3xl tracking-tight">
                    {{ $appConfig['app_judul'] ?? 'PT Nama Perusahaan' }}
                </h2>
    ...
    <div class="mb-8 au d1">
        <div class="flex items-center justify-between">
            ...
            <div
                class="hidden sm:flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-800/60 border border-slate-700/50 text-xs font-mono-custom text-slate-400">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 mb-6">
        ...
        <div class="stat-card rounded-2xl p-5 au d4">
            ...
            <p class="font-display font-700 text-3xl tracking-tight {{ $stokRendah > 0 ? 'text-red-400' : 'text-white' }}">
                {{ $stokRendah }}
            </p>
                ...
                <div class="{{ !$loop->last ? 'mb-4' : '' }}">
                    ...
                    <div class="h-1.5 rounded-full bg-slate-800 overflow-hidden">
                        <div class="h-full rounded-full"
                            style="width:{{ $item['pct'] }}%; background:{{ $barColors[$i % count($barColors)] }};"></div>
                    </div>
                </div>
            @empty
        ...
        <div class="chart-card rounded-2xl p-4 mb-4 au d6" style="border-color:rgba(248,113,113,0.25);">
            <div class="flex items-center gap-3">
                <div class="icon-badge shrink-0"
                    style="background:rgba(248,113,113,0.15);color:#f87171;width:36px;height:36px;border-radius:10px;">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-xs text-slate-500 font-mono-custom mt-0.5">
                        Terdapat <span class="text-red-400 font-medium">{{ $stokRendah }}</span> komponen dengan stok di bawah
                        batas minimal.
                    </p>
                </div>
                <a href="/komponen"
                    class="shrink-0 text-xs font-mono-custom text-red-400 hover:text-red-300 transition-colors flex items-center gap-1">
    ...
    <div class="chart-card rounded-2xl au d6">
        <div class="flex items-center justify-between px-6 py-5 border-b border-slate-800/60">
            ...
            <a href="/mutasi"
                class="text-xs font-mono-custom text-sky-400 hover:text-sky-300 transition-colors flex items-center gap-1">
