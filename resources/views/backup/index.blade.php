...
<div class="min-h-screen bg-gray-950 text-gray-100 font-sans">
    <div class="max-w-2xl mx-auto px-6 py-8">
        ...
        @if(session('success'))
            <div class="bg-emerald-500/10 border border-emerald-500/30 rounded-xl px-4 py-3 mb-5 flex items-center gap-2.5 text-emerald-400 text-sm">
        ...
        <div class="space-y-4">
            ...
            <div class="bg-gray-900 border border-gray-800 rounded-2xl overflow-hidden">
                ...
                <div class="px-5 py-4">
                    ...
                    <div class="flex items-start gap-2 bg-rose-500/5 border border-rose-500/20 rounded-xl px-3.5 py-3 mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-rose-400 shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v2m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <p class="text-xs text-rose-300/80 leading-relaxed">
                            <span class="font-semibold text-rose-400">Perhatian:</span>
                            Restore akan <strong>menghapus semua data saat ini</strong> dan menggantinya dengan data dari file backup. Pastikan file backup yang diupload benar.
                        </p>
                    </div>
                    ...
                    <form action="{{ route('backup.restore') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <label for="backup_file"
                            ...
                            id="dropzone">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 text-gray-600 group-hover:text-indigo-400 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M9 13h6m-3-3v6m5 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            </svg>
                            <div class="text-center">
                                <p class="text-sm text-gray-400 group-hover:text-gray-300 transition-colors" id="dropzone-label">
            ...
            <div class="bg-gray-900/50 border border-gray-800/60 rounded-2xl px-5 py-4">
                <p class="text-xs font-semibold text-gray-400 mb-3 uppercase tracking-wider">Cara Pindah Data ke PC Lain</p>
                <ol class="space-y-2">
                    @foreach([
